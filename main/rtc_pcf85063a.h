 ...
 * I2C configuration
 **/
// I2C0 pins for RTC (uses external I2C bus per Waveshare schematic)
#define I2C_MASTER_SCL_IO           9      /*!< GPIO9 - I2C0 SCL for RTC/Touch/CH422G */
#define I2C_MASTER_SDA_IO           8      /*!< GPIO8 - I2C0 SDA for RTC/Touch/CH422G */
#define I2C_MASTER_NUM              0                          /*!< I2C port 0 (GPIO8/9) */
