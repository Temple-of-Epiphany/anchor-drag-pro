...
#endif
#define LVGL_PORT_TICK_PERIOD_MS    (2)  // 2ms tick period
...
#define LVGL_PORT_TASK_MIN_DELAY_MS (1)      // The minimum delay of the LVGL timer task, in milliseconds
...
#define LVGL_PORT_TASK_CORE         (1)      // The core of the LVGL timer task (core 1)
...
#define LVGL_PORT_BUFFER_HEIGHT         (10)  // Not used in Mode 3

/**
 * Avoid tearing related configurations, can be adjusted by users.
 *
 */
#define LVGL_PORT_AVOID_TEAR_ENABLE     (1) // Set to 1 to enable (Mode 3)
 ...
 *
 */
#define LVGL_PORT_AVOID_TEAR_MODE       (3)  // Mode 3: Direct-Mode (recommended)
 ...
 *
 */
#define EXAMPLE_LVGL_PORT_ROTATION_DEGREE  (0)  // No rotation
